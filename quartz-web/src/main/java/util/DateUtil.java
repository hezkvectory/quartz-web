...
public final class DateUtil {
	  ...
	  public static void main(String []args){
		  Date d= DateUtil.AddMonth(new Date(), 5);
		  Date d2= DateUtil.AddMonth(d, -2);
		  System.out.println(DateUtil.getLastMonthDay(d2,0L));
		  System.out.println(DateUtil.getLastMonthDay(d2,1L));
		  System.out.println(DateUtil.getDateByStrYYYYMM("2013-9"));
		 // System.out.println(DateUtil.getLastMonthDay(DateUtil.getDateByStrYYYYMM("2013-9"),0L));
			Date cdate=DateUtil.getDateByStrYYYYMM("2013-8");
			Calendar cal = Calendar.getInstance();	
			cal.setTime(cdate);		
			int day = cal.getActualMaximum(Calendar.DAY_OF_MONTH);//起始天数
...
//	    	  System.out.println("相差的日期:"   +   day); 
	     ...
	     * @return
	     */
	    public static long dateSubHour(Date date1, Date date2){
	    	  if(date2 == null) date2 = new Date();
...
//	    	  System.out.println("相差的日期:"   +   day); 
	 ...
	 * @return
	 */
	public static String getLastMonthDay(Date date,Long state) {
		Calendar cal = Calendar.getInstance();	
		cal.setTime(date);
		int year = 0;
	...
	*/  
     ...
     * 得到小时后的时间 
     */  
	public static Date getDateAfterHour(Date inDate, int hour) {  
		Calendar now = Calendar.getInstance();  
		now.setTime(inDate);  
